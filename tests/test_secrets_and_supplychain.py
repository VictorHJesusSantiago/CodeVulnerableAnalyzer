...
def test_baseline_roundtrip(tmp_path):
    from analyzer.secrets_baseline import filter_new_secrets, save_secrets_baseline

    fake_aws = "AKIA" + "ABCDEFGHIJKLMNOP"
    findings = [
        {"file_path": "a.py", "line_number": 1, "provider": "AWS", "secret_type": "Access Key ID", "matched": fake_aws}
    ]
...
def test_baseline_detects_new_secret(tmp_path):
    ...
    new_findings = [
        {"file_path": "b.py", "line_number": 1, "provider": "GitHub", "secret_type": "PAT", "matched": "ghp_x"}
    ]
...
def test_vex_roundtrip_and_suppression(tmp_path):
    ...
    kept, suppressed = suppress_by_vex([FakeDepVuln("CVE-2024-1", "pkgA"), FakeDepVuln("CVE-2024-2", "pkgB")], doc2)
