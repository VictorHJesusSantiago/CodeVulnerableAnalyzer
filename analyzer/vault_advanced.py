...
@dataclass
class SecretVersion:
    version:int; nonce:str; cipher:str; tag:str; created_at:float; expires_at:float | None; metadata:dict[str,Any]
...
class AdvancedVault:
    ...
    def verify_audit(self)->bool:
        ...
        for item in self.audit:
            ...
            prev=item["signature"]
        return True
    def put(self,name:str,value:str,actor:str,ttl:int | None=None,metadata:dict[str, Any] | None=None)->int:
